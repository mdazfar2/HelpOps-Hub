...
function HomePage({ theme }) {
  ...
  <div className="profileCard_container relative p-14 border-2 border-dashed rounded-full border-spacing-4 border-gray-400/50 rotate">
    <button className="profile_item left-[55px] -top-[12px] absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[2px] active:scale-95 hover:scale-95 transition-all duration-500 rotatebutton">
    ...
    <button className="profile_item right-[45px] -top-[8px] absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[2px] active:scale-95 hover:scale-95 transition-all duration-500 rotatebutton">
    ...
    <button className="profile_item -left-8 top-20 absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[2px] active:scale-95 hover:scale-95 transition-all duration-500 rotatebutton">
    <span className="block w-[65px] h-[65px] transition-all duration-500 rounded-full z-[2] bg-white p-1">     
    <svg viewBox="0 0 128 128">   
    ...
    <button className="profile_item -right-8 top-20 absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[2px] active:scale-95 hover:scale-95 transition-all duration-500 rotatebutton">
      <span className="block w-[65px] h-[65px] transition-all duration-500 rounded-full z-[2] bg-white p-1">
    ...
    <button className="profile_item bottom-8 -left-4 absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[2px] active:scale-95 hover:scale-95 transition-all duration-500 rotatebutton">
      <span className="block w-[65px] h-[65px] transition-all duration-500 rounded-full z-[2] bg-white p-1">
    ...
    <button className="profile_item bottom-8 -right-4 absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[2px] active:scale-95 hover:scale-95 transition-all duration-500 rotatebutton">
    <span className="block w-[65px] h-[65px] transition-all duration-500 rounded-full z-[2] bg-white p-1">
    ...
    <button className="profile_item right-[40%] -bottom-8 absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[2px] active:scale-95 hover:scale-95 transition-all duration-500 rotatebutton">
    <span className="block w-[65px] h-[65px] transition-all duration-500 rounded-full z-[2] bg-white p-1">
    ...
    <button className="profile_item w-[200px] h-[200px] p-1 border-2 rounded-full hover:border-gray-400/50 cursor-pointer transition-all duration-500 z-0 rotatebutton">
      <div className="w-full h-full flex items-center justify-center p-2 rounded-full active:scale-95 hover:scale-95 object-cover transition-all duration-500">
        <span className="w-20 h-20 inline-block">
          <img src="./new/HelpOps-H Fevicon.webp" class="w-full h-full object-cover rounded-full" />
        </span>
      </div>
    </button>
  </div>
