  ...
  {selectedTab === "Posts" && (
    <div className={`${theme? "text-black":"text-white"}`}>
      {blogs && blogs.length > 0 ? (
        blogs
          .filter((blog) => blog.authorId === (isViewProfile ? viewUserDetails._id : finalUser._id))
          .map((blog) => (
...
export default function ProfilepageDetails({ isViewProfile, id }) {
  ...
  return (
    <div className="relative overflow-hidden w-full h-full bg-gray-200">
      ...
      <div
        className={`absolute  ${
          isViewProfile ? "left-[20px]" : "left-[40px]"
        } top-[10px]`}
      >
        <FaShareFromSquare
          color="black"
        ...
        >
          ...
          {isShare && (
            <div className="auth-overlay">
              ...
              >
                <div
                  className={`z-500 w-[500px] gap-6 border-dashed rounded-lg p-6 border-2 flex flex-col items-center ${
                    theme
